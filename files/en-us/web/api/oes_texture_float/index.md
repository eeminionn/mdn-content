...
> [!NOTE]
> This extension is only available to {{domxref("WebGLRenderingContext", "WebGL1", "", 1)}} contexts. In {{domxref("WebGL2RenderingContext", "WebGL2", "", 1)}}, use the appropriate WebGL 2 texture formats and color-buffer extensions such as {{domxref("EXT_color_buffer_float")}} or {{domxref("EXT_color_buffer_half_float")}} instead.
